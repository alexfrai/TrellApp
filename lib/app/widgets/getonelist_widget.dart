            ...
            child: GestureDetector(
              onTap: () {
                ...
                setState(() {
                  editingLists.add(
                    widget.list['id'],
                  ); // Active l'édition pour cette liste
                });
              },
              child:
                  editingLists.contains(widget.list['id'])
                      ? TextField(
                        controller: listNameController,
                        autofocus: true,
                        onSubmitted: (newName) => _updateListName(newName),
                        onEditingComplete: () {
                          _updateListName(listNameController.text);
                          setState(() {
                            editingLists.remove(
                              widget.list['id'],
                            ); // Désactive l'édition après mise à jour
                          });
                        },
